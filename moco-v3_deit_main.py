# This script runned for me only in cpu cause I get out of memory!
import argparse
import cv2
import numpy as np
import torch
...
def reshape_transform(tensor, height=14, width=14): # 14*14 original
...
if __name__ == '__main__':
    ...
    state_dict = torch.load("pretrained_weights/linear-vit-b-300ep.pth.tar")['state_dict'] # load the weights of the pretrained model and rename the keys
